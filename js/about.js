...
function activeWork(){
    linkWorks.forEach(L=> L.classList.remove('active-work'))
    this.classList.add('active-work')
}

linkWorks.forEach(L=> L.addEventListener('click', activeWork))
...
var typed = new Typed(".typing",{
    strings: ["César", "Catalyze", "Johann", "Jorge","Johnny"],
    typeSpeed: 120,
    backSpeed: 60,
    loop: true
});
...
//Activated / Desactivated the theme manually with the button
